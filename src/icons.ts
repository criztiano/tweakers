// Shared SVG icon geometry — single source of truth across all framework adapters.
...
// Repeat/loop glyph (stroke-rendered), used by the timeline loop-region toggle.
...
export const ICON_CLOSE = 'M6 6L18 18M6 18L18 6';
...
// The loop and copy pills' glyphs, drawn to the capture glyph's grid so the
// four pills read as one family. Loop is two arrows chasing each other —
// the hardware's cycle mark, simplified for 14px — and copy is the printed
// two-sheets mark, as outlines like the capture corners.
export const ICON_MOVE_LOOP = {
  viewBox: '0 0 14 14',
...
export const LUCIDE_ICONS: Record<string, string[]> = {
  ...
  'brush-cleaning': [
    'm16 22-1-4', 'M19 13.99a1 1 0 0 0 1-1V12a2 2 0 0 0-2-2h-3a1 1 0 0 1-1-1V4a2 2 0 0 0-4 0v5a1 1 0 0 1-1 1H6a2 2 0 0 0-2 2v.99a1 1 0 0 0 1 1',
    'M5 14h14l1.973 6.767A1 1 0 0 1 20 22H4a1 1 0 0 1-.973-1.233z', 'm8 22 1-4',
  ],
  sparkles: [
  ...
  'broom-sparkles': [
    ...
    'M20 15v4', 'M22 17h-4', 'M4 4v4', 'm5 18 2-2', 'M6 6H2', 'm7.699 10.7 5.602 5.601',
  ],
  stethoscope: [
    'M11 2v2', 'M5 2v2', 'M5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1',
    'M8 15a6 6 0 0 0 12 0v-3', 'M20 8a2 2 0 1 0 0 4 2 2 0 1 0 0-4',
  ],
  'file-volume': [
    'M4 11.55V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.706.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2h-1.95',
    'M14 2v5a1 1 0 0 0 1 1h5', 'M12 15a5 5 0 0 1 0 6',
  ...
  'cassette-tape': [
    ...
    'M8 8a2 2 0 1 0 0 4 2 2 0 1 0 0-4', 'M8 12h8', 'M16 8a2 2 0 1 0 0 4 2 2 0 1 0 0-4',
    'm6 20 .7-2.9A1.4 1.4 0 0 1 8.1 16h7.8a1.4 1.4 0 0 1 1.4 1l.7 3',
  ],
  'audio-lines-x': [
    'M2 10v3', 'M6 6v11', 'M10 3v18', 'M14 8v7', 'M18 5v6', 'M22 10v3', 'm16 17 5 5', 'm21 17-5 5',
  ],
  'disc-3': [
    'M12 2a10 10 0 1 0 0 20 10 10 0 1 0 0-20z', 'M6 12c0-1.7.7-3.2 1.8-4.2',
    'M12 10a2 2 0 1 0 0 4 2 2 0 1 0 0-4z', 'M18 12c0 1.7-.7 3.2-1.8 4.2',
  ],
  'boom-box': [
    'M4 9V5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4', 'M8 8v1', 'M12 8v1', 'M16 8v1',
    'M4 9h16a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2z',
    'M8 13a2 2 0 1 0 0 4 2 2 0 1 0 0-4', 'M16 13a2 2 0 1 0 0 4 2 2 0 1 0 0-4',
  ],
};
