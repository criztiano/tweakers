...
export declare const ICON_CHEVRON_RIGHT = "M9.5 6L15.5 12L9.5 18";
export declare const ICON_CHEVRON_LEFT = "M14.5 6L8.5 12L14.5 18";
...
export declare const ICON_MOVE_LOOP: {
    viewBox: string;
    paths: string[];
};
export declare const ICON_MOVE_COPY: {
    viewBox: string;
    paths: string[];
};
/**
 ...
 */
export declare const MOVE_FUNCTION_ICONS: Record<string, MoveFunctionGlyph>;
