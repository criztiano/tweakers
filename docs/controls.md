...
| `MoveWaveform` / `MoveWaveformStore` | The sample on the kit's card (light display, dark frame, ≤1200×176): wheel zoom, knob scrub, step loop, the clock with the host's play/loop state |
