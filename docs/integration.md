...
The value row under a seated chip stays free: another chip named to the same
`movePads` column sits right under it, and both take that column's knob — a
tap on one releases the other.
