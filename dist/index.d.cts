...
declare function MoveSlotDefaultBody({ label, value, pct, originPct, }: {
    label: string;
    value: ReactNode;
    /** Fill extent, 0–100. */
    pct: number;
 ...
 * picture.
 */
declare function FilterControl({ control, value, onChange }: FilterControlProps): react.JSX.Element;
