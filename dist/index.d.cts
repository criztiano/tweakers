...
interface MoveActionDeckProps {
    ...
    actions: readonly MoveDeckAction[];
    className?: string;
}
/**
 ...
 * Sampling key, Capture, Loop, Mute). Each is dressed like the hardware key
 * it rides, the way `MoveActionButton` is, and the deck attaches the same
