 ...
 */
type MoveSlotKind = 'default' | 'value' | 'icon' | 'curve' | 'enum' | 'xy' | 'range' | 'filter' | 'color' | 'opacity' | 'blur' | 'pan' | 'stereo-width' | 'pitch' | 'playback';
