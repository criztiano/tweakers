 ...
 */
declare function MovePanel({ theme, productionEnabled, panels: only, dock, scroll, headerStart }: MovePanelProps): react_jsx_runtime.JSX.Element | null;
