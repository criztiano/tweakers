...
__export(index_exports, {
  ...
  SH_DEF: () => SH_DEF,
  TAB_PATH: () => import_TweakStore12.TAB_PATH,
  TRANSFER_MAX_POINTS: () => TRANSFER_MAX_POINTS,
  TRANSFER_MIN_GAP: () => TRANSFER_MIN_GAP,
  TimelineStore: () => TimelineStore,
  TweakStore: () => import_TweakStore12.TweakStore,
  ...
  defaultListItemParams: () => import_TweakStore12.defaultListItemParams,
  ...
  groupListFields: () => import_TweakStore12.groupListFields,
  handleLeftStyles: () => handleLeftStyles,
  hintDomId: () => import_TweakStore12.hintDomId,
  hslToRgb: () => hslToRgb,
  hsvToRgb: () => hsvToRgb,
  ...
  normalizeListItems: () => import_TweakStore12.normalizeListItems,
  ...
  parseHex: () => parseHex,
  parseListItemSchema: () => import_TweakStore12.parseListItemSchema,
...
var MoveVolumeDisplayClass = class {
  ...
  set(state2) {
    import_TweakStore.TweakStore.noteMoveKitUse("volume");
    this.state = state2;
    this.notify();
  }
  /** Hide the pill. */
...
var MoveWaveformStoreClass = class {
  ...
  register() {
    import_TweakStore2.TweakStore.noteMoveKitUse("waveform");
...
function MoveSlotReadout({ label, value }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "tweakers-move-dial-readout", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "tweakers-move-dial-value", children: split?.unit ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "tweakers-move-dial-number", children: split.num }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "tweakers-move-dial-unit", children: split.unit })
    ] }) : value })
  ] });
}
...
function MoveSlotRampBody({ label, value, css, stop, stops }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(MoveSlotDisplay, { children: [
      ...
      (stops ?? []).map((p, i) => p === stop ? null : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "tweakers-move-slot-tick", "data-quiet": true, style: { left: tickLeft(p) } }, i)),
...
function MovePadColorBody({ label, color }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "tweakers-move-pad-title", children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "tweakers-move-pad-swatch", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { background: color } }) })
  ] });
}
function MovePadTabsBody({ name, options, activeIdx }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    name != null && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "tweakers-move-tabs-head", children: name }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "tweakers-move-tabs-run", children: options.map((opt, i) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        "span",
        {
          ...
          children: glyph ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(MoveSlotGlyph, { name: glyph, className: "tweakers-move-tab-icon" }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "tweakers-move-tab-title", children: enumOptionLabel(opt) })
        },
        enumOptionValue(opt)
      );
    }) })
...
var used = () => import_TweakStore4.TweakStore.noteMoveKitUse("surface");
...
var MoveColorStoreClass = class {
  ...
  gradient(panelId, path) {
    const v = import_TweakStore6.TweakStore.getValue(panelId, path);
  ...
  moveStop(panelId, path, index, position) {
    ...
    if (!g || import_TweakStore6.TweakStore.isDisabled(panelId, path) || !Number.isFinite(position)) return;
    ...
    import_TweakStore6.TweakStore.updateValue(panelId, path, {
      ...g,
  ...
  hexAt(panelId, path, stop) {
    ...
    return String(import_TweakStore6.TweakStore.getValue(panelId, path) ?? "#ff0000");
  }
  ...
  updateStop(panelId, path, stop, patch2) {
    ...
    if (g && stop !== null) import_TweakStore6.TweakStore.updateValue(panelId, path, setStopColor(g, stop, hex));
    else import_TweakStore6.TweakStore.updateValue(panelId, path, hex);
    this.notify();
  }
  setHue(h) {
...
function MoveColorSlot({ panelId, meta, active, open: open2, latched = false }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
    "button",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(MoveSlotColorBody, { label: meta.label, color: String(import_TweakStore7.TweakStore.getValue(panelId, meta.path)), hue: color.h })
    }
  );
}
...
function MoveGradientRamp({ panelId, path, gradient, disabled }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
    "div",
    {
      ...
      children: gradient.stops.map((stop, index) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        "button",
        {
          type: "button",
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        gradient && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(MoveGradientRamp, { panelId, path: meta.path, gradient, disabled }),
...
var MoveFunctionsClass = class {
  ...
  attach(name, handler, options) {
    ...
    import_TweakStore8.TweakStore.noteMoveKitUse("functions");
...
function Chip({ chip }) {
  ...
  const flashTimer = (0, import_react7.useRef)(void 0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ChipGlyph, { glyph: MOVE_FUNCTION_ICONS[chip.name] }),
        chip.label
      ]
    }
  );
...
function MoveFunctionChips({ className }) {
  const [chips, setChips] = (0, import_react7.useState)(() => MoveFunctions.chips());
  (0, import_react7.useEffect)(() => {
    setChips(MoveFunctions.chips());
    return MoveFunctions.subscribe(() => setChips(MoveFunctions.chips()));
  }, []);
  if (!chips.length) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: className ? `tweakers-move-chips ${className}` : "tweakers-move-chips", children: chips.map((chip) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Chip, { chip }, chip.name)) });
}
...
var MovePresetStoreClass = class {
  ...
  items(panelId) {
    const provider = import_TweakStore9.TweakStore.getPresetProvider(panelId);
    if (provider) return provider.presets.map((p) => ({ id: p.id, label: p.label }));
    return import_TweakStore9.TweakStore.getPresets(panelId).map((p) => ({ id: p.id, label: p.name }));
  }
  /** Play a row's values without recording them — the browsing preview. */
  applyPreview(id) {
    const view = this.view;
    if (!view || !id || !this.previewEnabled || !this.original) return;
    const preset = import_TweakStore9.TweakStore.getPresets(view.panelId).find((p) => p.id === id);
    if (preset) import_TweakStore9.TweakStore.previewValues(view.panelId, preset.values);
  }
  open(panelId) {
    this.clearTimers();
    const active = import_TweakStore9.TweakStore.getActivePresetId(panelId);
    const items = this.items(panelId);
    const cursor = (active && items.some((i) => i.id === active) ? active : items[0]?.id) ?? null;
    this.original = import_TweakStore9.TweakStore.getPresetProvider(panelId) ? null : { ...import_TweakStore9.TweakStore.getValues(panelId) };
  ...
  cancel() {
    ...
    if (this.original) import_TweakStore9.TweakStore.previewValues(view.panelId, this.original);
  ...
  compareStart() {
    ...
    import_TweakStore9.TweakStore.previewValues(view.panelId, this.original);
    this.notify();
  }
  ...
  choose(id) {
    ...
    if (!this.items(view.panelId).some((i) => i.id === id)) return;
    const provider = import_TweakStore9.TweakStore.getPresetProvider(view.panelId);
    if (provider) void provider.onSelect(id);
    else import_TweakStore9.TweakStore.loadPreset(view.panelId, id);
  ...
  commitSave(name) {
    ...
    const provider = import_TweakStore9.TweakStore.getPresetProvider(saving.panelId);
    if (provider) void provider.onCreate(label);
    else import_TweakStore9.TweakStore.savePreset(saving.panelId, label);
    this.saving = null;
    this.notify();
  }
};
...
function MovePanel({ theme = "system", productionEnabled = isDevDefault, panels: only, dock = "viewport", scroll = false, headerStart, settings, functionChips = "clock" }) {
  if (!productionEnabled) return null;
  const [panels, setPanels] = (0, import_react8.useState)([]);
  const [track, setTrack] = (0, import_react8.useState)(0);
  const [dragPath, setDragPath] = (0, import_react8.useState)(null);
  const [bendHeld, setBendHeld] = (0, import_react8.useState)(null);
  const bendRef = (0, import_react8.useRef)(null);
  const [waveHeld, setWaveHeld] = (0, import_react8.useState)(null);
  const waveRef = (0, import_react8.useRef)(null);
  const [handTouch, setHandTouch] = (0, import_react8.useState)({});
  const [curvePoint, setCurvePoint] = (0, import_react8.useState)({});
  const [rampStop, setRampStop] = (0, import_react8.useState)({});
  const rampGesture = (0, import_react8.useRef)(null);
  const [hwHeld, setHwHeld] = (0, import_react8.useState)({});
  const [hwLatched, setHwLatched] = (0, import_react8.useState)({});
  const [appHeld, setAppHeld] = (0, import_react8.useState)(null);
  const [held, setHeld] = (0, import_react8.useState)(null);
  const [latched, setLatched] = (0, import_react8.useState)({});
  const holdStart = (0, import_react8.useRef)(0);
  const [mounted, setMounted] = (0, import_react8.useState)(false);
  const pageTabsId = (0, import_react8.useId)();
  const panelRef = (0, import_react8.useRef)(null);
  const [dotDrag, setDotDrag] = (0, import_react8.useState)(null);
  const fineRef = (0, import_react8.useRef)(null);
  const rangeHandleRef = (0, import_react8.useRef)("min");
  const filterHandRef = (0, import_react8.useRef)("cutoff");
  const [volume, setVolume] = (0, import_react8.useState)(() => MoveVolumeDisplay.get());
  const [liveValue, setLiveValue] = (0, import_react8.useState)(null);
  ...
  const read = (0, import_react8.useCallback)(() => {
    if (onlyKey === void 0) return import_TweakStore10.TweakStore.selectPanels();
    const requested = JSON.parse(onlyKey);
    const registered = import_TweakStore10.TweakStore.getPanels("panel");
    return requested.map((key) => registered.find((panel) => panel.id === key || panel.name === key)).filter((panel) => panel !== void 0);
  }, [onlyKey]);
  (0, import_react8.useEffect)(() => {
    setMounted(true);
    setPanels(read());
    return import_TweakStore10.TweakStore.subscribeGlobal(() => setPanels(read()));
  }, [read]);
  const settingsKey = settings === void 0 ? void 0 : JSON.stringify(Array.isArray(settings) ? settings : [settings]);
  const settingsRooms = settingsKey === void 0 ? [] : JSON.parse(settingsKey).map((key) => import_TweakStore10.TweakStore.getPanels("panel").find((p) => p.id === key || p.name === key)).filter((p) => p !== void 0);
  ...
  const settingsPanel = modSettings ? import_TweakStore10.TweakStore.getPanel(modSettings.panelId) : void 0;
  ...
  const [offset, setOffset] = (0, import_react8.useState)(0);
  const stripOffset = stripMode ? clampStripOffset(page, offset) : 0;
  const stripRef = (0, import_react8.useRef)({
    page: void 0,
    offset: 0,
    on: false
  });
  stripRef.current = { page, offset: stripOffset, on: stripMode };
  const scrollSlots = (0, import_react8.useCallback)((delta) => {
  ...
  const scrollPage = (0, import_react8.useCallback)((dir) => {
    const { page: pg, offset: cur, on } = stripRef.current;
    if (!on || !pg || !dir) return;
  ...
  const wheelRest = (0, import_react8.useRef)(0);
  (0, import_react8.useEffect)(() => {
  ...
  const announceStrip = (0, import_react8.useCallback)(() => {
  ...
  (0, import_react8.useSyncExternalStore)(MoveColorStore.subscribe, MoveColorStore.getVersion, () => 0);
  ...
  (0, import_react8.useSyncExternalStore)(MovePresetStore.subscribe, MovePresetStore.getVersion, () => 0);
  ...
  const values = (0, import_react8.useSyncExternalStore)(
    (0, import_react8.useCallback)((cb) => pageId ? import_TweakStore10.TweakStore.subscribe(pageId, cb) : () => {
    }, [pageId]),
    () => pageId ? import_TweakStore10.TweakStore.getValues(pageId) : void 0,
    () => void 0
  );
  const [, bumpControlState] = (0, import_react8.useState)(0);
  (0, import_react8.useEffect)(
    () => pageId ? import_TweakStore10.TweakStore.subscribeControlState(pageId, () => bumpControlState((n) => n + 1)) : void 0,
    [pageId]
  );
  (0, import_react8.useSyncExternalStore)(
    (0, import_react8.useCallback)((cb) => import_ModulationStore2.ModulationStore.subscribe(cb), []),
    () => import_ModulationStore2.ModulationStore.getVersion(),
    () => 0
  );
  const surface = (0, import_react8.useSyncExternalStore)(
    (0, import_react8.useCallback)((cb) => MoveSurfaceStore.subscribe(cb), []),
  ...
  const pagesRef = (0, import_react8.useRef)(pages);
  pagesRef.current = pages;
  const roomIdsRef = (0, import_react8.useRef)(roomIds);
  roomIdsRef.current = roomIds;
  const sawSettings = (0, import_react8.useRef)(false);
  const sawRoom = (0, import_react8.useRef)(false);
  (0, import_react8.useEffect)(() => {
    const onPage = (e) => {
  ...
  const dialFromKeyboard = (e, meta) => {
    if (e.altKey || e.ctrlKey || e.metaKey || import_TweakStore10.TweakStore.isDisabled(page.panel.id, meta.path)) return;
    const next = moveKeyboardValue(meta, values[meta.path], e.key, e.shiftKey);
    if (next === null) return;
    e.preventDefault();
    e.stopPropagation();
    armMod(meta.path);
    import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, next);
  };
  const dialFromPointer = (e, meta) => {
    ...
    import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, denormalizeDial(meta, v01));
  };
  const xyFromPointer = (e, meta) => {
    ...
    import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, {
  ...
  const transferFromPointer = (e, meta, down) => {
    ...
    import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, { points: movePoint(points, index, x, y) });
  };
  const needleFromPointer = (e, meta) => {
    ...
    if (next !== null) import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, next);
  };
  const rampFromPointer = (e, meta, down) => {
    ...
    import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, { ...g, stops });
  };
  const xyRelease = (meta) => {
    ...
    const xa = resolveAxis(meta.xAxis);
    const ya = resolveAxis(meta.yAxis);
    import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, normalizeValue(centerValue(xa, ya), xa, ya, !!meta.snap));
  };
  const rangeFromPointer = (e, meta, down) => {
    ...
    import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, denormalizeRangeDial(meta, next.lo, next.hi));
  };
  ...
  const enumFromPointer = (e, meta) => {
    ...
    import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, denormalizeEnumDial(meta, v01));
  };
  ...
  const headerCluster = (volume || functionChips === "clock") && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "tweakers-move-actions", children: [
    functionChips === "clock" && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(MoveFunctionChips, {}),
    volume && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "tweakers-move-volume", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "tweakers-move-volume-tick", style: { background: MOVE_TRACK_COLORS[0] } }),
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "tweakers-move-tracks", children: [
            audioWave != null ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(MoveAudioZoom, {}) : /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "tweakers-move-tracks-group", children: [
              settingsOpen && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "tweakers-move-settings-title", children: [
                ...
                roomPages.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "tweakers-move-pages", role: "tablist", "aria-label": "Settings pages", children: roomPages.map((pg, i) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "tweakers-move-track-marker", style: { background: MOVE_TRACK_COLORS[i] } }),
                      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "tweakers-move-track-label", children: pg.panel.name })
                    ]
                  },
                  pg.panel.id
                )) }) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "tweakers-move-track-label", children: page.panel.name })
              ] }),
              !settingsOpen && gradientMeta && gradientValue && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "tweakers-move-pages", role: "tablist", "aria-label": `${gradientMeta.label} stops`, "data-stops": true, children: gradientValue.stops.slice(0, MOVE_GRADIENT_STOPS).map((stop, i) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
                "button",
                {
                  type: "button",
                  role: "tab",
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "tweakers-move-track-marker", style: { background: stop.color } }),
                    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { className: "tweakers-move-track-label", children: [
                      "Stop ",
                      i + 1
                    ] })
                  ]
              ...
              !settingsOpen && !gradientMeta && pages.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "tweakers-move-pages", role: "tablist", "aria-label": "Move pages", children: pages.map((pg, i) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
                "button",
                {
                  id: `${pageTabsId}-tab-${i}`,
                  type: "button",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "tweakers-move-mods", children: settingsOpen ? null : color && colorMeta ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(MoveColorSteps, { color, disabled: import_TweakStore10.TweakStore.isDisabled(page.panel.id, colorMeta.path) }) : surface.steps === null ? import_ModulationStore2.ModulationStore.getSlots().map((slot) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(MoveModCircle, { slot }, slot.index)) : null }),
                        ...
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "tweakers-move-dials", "data-scroll": stripMode || void 0, children: visibleCols.map((i) => {
                              ...
                              const disabled = import_TweakStore10.TweakStore.isDisabled(page.panel.id, meta.path);
                                ...
                                return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
                                  "div",
                                  {
                                    ...
                                    onPointerUp: () => {
                                      ...
                                      setDragPath(null);
                                      fineRef.current = null;
                                      if (tapped && editable && !import_TweakStore10.TweakStore.isDisabled(page.panel.id, meta.path)) {
                              ...
                              if (isEnumDial(meta)) {
                                ...
                                return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
                                  "div",
                                  {
                                    ...
                                    "data-active": active || void 0,
                                    onPointerDown: (e) => {
                                      if (import_TweakStore10.TweakStore.isDisabled(page.panel.id, meta.path)) return;
                                      try {
                                        e.currentTarget.setPointerCapture(e.pointerId);
                                      } catch {
                                      }
                                    ...
                                    onPointerMove: (e) => {
                                      if (!import_TweakStore10.TweakStore.isDisabled(page.panel.id, meta.path) && dragPath === meta.path) enumFromPointer(e, meta);
                                    },
                                    onPointerUp: () => {
                                      setDragPath(null);
                                      fineRef.current = null;
                              ...
                              if (meta.type === "toggle") {
                                ...
                                return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
                                  "button",
                                  {
                                    ...
                                    disabled,
                                    onClick: () => {
                                      if (!import_TweakStore10.TweakStore.isDisabled(page.panel.id, meta.path)) {
                                        import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, !checked);
                                      }
                                    },
                                    children: [
                                      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(MoveModRing, { panelId: page.panel.id, path: meta.path }),
                              ...
                              return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
                                "div",
                                {
                                  ...
                                  onPointerMove: (e) => {
                                    if (!import_TweakStore10.TweakStore.isDisabled(page.panel.id, meta.path) && dragPath === meta.path) dialFromPointer(e, meta);
                                  },
                                  onPointerUp: () => {
                                    setDragPath(null);
                                    fineRef.current = null;
                            ...
                            color && colorMeta ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(MoveOpacityPads, { color, disabled: import_TweakStore10.TweakStore.isDisabled(page.panel.id, colorMeta.path) }) : shownPadRows.map((row) => {
                              if (appRowAt(row) !== null) {
                                ...
                                return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                                  "div",
                                  {
                                    ...
                                    children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "tweakers-move-app-row-label", children: surface.padsLabel ?? "the app\u2019s pads" })
                                  },
                                  "app-rows"
                                );
                              }
                                      ...
                                      return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
                                        "div",
                                        {
                                          ...
                                          children: [
                                            ...
                                            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "tweakers-move-tab-zones", role: "tablist", "aria-label": meta.label, children: options.map((opt, i) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                                              "button",
                                              {
                                                type: "button",
                                                role: "tab",
                                                ...
                                                onClick: () => import_TweakStore10.TweakStore.updateValue(
                                                  page.panel.id,
                                                  meta.path,
                                                  enumOptionValue(opt)
                                                ),
                                    ...
                                    if (padRows[row] === page.toggles && meta.type !== "color") {
                                      return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                                        "button",
                                        {
                                          ...
                                          onClick: () => import_TweakStore10.TweakStore.updateValue(page.panel.id, meta.path, !values[meta.path]),
                                    ...
                                    if (padRows[row] === page.actions) {
                                      return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                                        "button",
                                        {
                                          className: "tweakers-move-pad",
                                          "data-kind": "action",
                                          onClick: () => import_TweakStore10.TweakStore.triggerAction(page.panel.id, meta.path),
...
function MoveModCircle({ slot }) {
  ...
  const pressAt = (0, import_react8.useRef)(0);
  (0, import_react8.useEffect)(() => {
...
function useDockBottom(active) {
  const [bottom, setBottom] = (0, import_react10.useState)(MOVE_NOTIFY_GAP);
...
function NotifyStack({ className }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    import_toast.Toast.Viewport,
    {
      ...
      children: toasts.map((toast) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_toast.Toast.Root, { toast, className: "tweakers-move-notify-card", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_toast.Toast.Content, { className: "tweakers-move-notify-body", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "tweakers-move-notify-text", children: [
          toast.type && toast.type !== "info" && /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { className: "tweakers-move-notify-kind", children: [
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "tweakers-move-notify-dot", "aria-hidden": "true" }),
            toast.type
          ] }),
          toast.title != null && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_toast.Toast.Title, { className: "tweakers-move-notify-title" }),
          toast.description != null && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_toast.Toast.Description, { className: "tweakers-move-notify-description" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_toast.Toast.Action, { className: "tweakers-move-notify-action" }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_toast.Toast.Close, { className: "tweakers-move-notify-close", "aria-label": "Dismiss", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("svg", { viewBox: "0 0 24 24", width: "14", height: "14", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: ICON_CLOSE }) }) })
      ] }) }, toast.id))
    }
  );
}
function MoveNotifications({
  ...
  return (0, import_react_dom4.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "tweakers-root tweakers-move-surface tweakers-move-notify-root", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_toast.Toast.Provider, { toastManager: manager, limit, timeout, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(NotifyStack, { ...className ? { className } : {} }) }) }),
    document.body
  );
}
