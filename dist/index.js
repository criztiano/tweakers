...
function MoveSlotGlyph({ name, className }) {
  ...
  return /* @__PURE__ */ jsx43(
    "svg",
    {
      ...
      strokeLinejoin: "round",
      "aria-hidden": "true",
      children: paths.map((d) => /* @__PURE__ */ jsx43("path", { d }, d))
    }
  );
}
function MoveSlotReadout({ label, value }) {
  return /* @__PURE__ */ jsxs38("div", { className: "tweakers-move-dial-readout", children: [
    /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-label", "data-long": label.length > 9 || void 0, children: label }),
    /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-value", children: value })
  ] });
}
function MoveSlotShape({ d, className = "tweakers-move-dial-shape" }) {
  return /* @__PURE__ */ jsx43("svg", { className, viewBox: "0 0 100 100", preserveAspectRatio: "none", "aria-hidden": "true", children: /* @__PURE__ */ jsx43("path", { d }) });
}
function MoveSlotDefaultBody({
  ...
  return /* @__PURE__ */ jsxs38(Fragment10, { children: [
    /* @__PURE__ */ jsx43(MoveSlotReadout, { label, value }),
    /* @__PURE__ */ jsxs38("div", { className: "tweakers-move-dial-bar", children: [
      /* @__PURE__ */ jsx43(
        "div",
        {
      ...
      atOrigin && /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-zero", style: { left: `${originPct}%` } })
    ] })
  ] });
}
...
function MoveSlotEnumBody({
  ...
  return /* @__PURE__ */ jsxs38(Fragment10, { children: [
    picture ? /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-tag", children: label }) : /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-head", children: label }),
    shape && /* @__PURE__ */ jsx43(MoveSlotShape, { d: shape }),
    glyph && /* @__PURE__ */ jsx43(MoveSlotGlyph, { name: glyph, className: "tweakers-move-dial-icon" }),
    picture ? /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-option", children: optionLabel }) : /* @__PURE__ */ jsx43(
      ListScreen,
      {
    ...
    (picture || scrolls) && /* @__PURE__ */ jsx43("div", { className: "tweakers-move-dial-bar", children: /* @__PURE__ */ jsx43("div", { className: "tweakers-move-dial-enum", children: options.map((opt, j) => /* @__PURE__ */ jsx43(
      "span",
      {
...
function MoveSlotRangeBody({
  ...
  return /* @__PURE__ */ jsxs38(Fragment10, { children: [
    /* @__PURE__ */ jsx43(MoveSlotReadout, { label, value }),
    /* @__PURE__ */ jsx43("div", { className: "tweakers-move-dial-bar", children: /* @__PURE__ */ jsxs38("div", { className: "tweakers-move-dial-range", children: [
      /* @__PURE__ */ jsx43(
        "div",
        {
      ...
      /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-handle", style: { left: `${lo * 100}%` } }),
      /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-handle", style: { left: `${hi * 100}%` } })
    ] }) })
  ] });
}
function MoveSlotFilterBody({
  ...
  return /* @__PURE__ */ jsxs38(Fragment10, { children: [
    /* @__PURE__ */ jsx43("div", { className: "tweakers-move-filter-display", children: shape && /* @__PURE__ */ jsx43(MoveSlotShape, { d: shape, className: "tweakers-move-filter-shape" }) }),
    /* @__PURE__ */ jsxs38("div", { className: "tweakers-move-filter-readout", "data-side": "cutoff", children: [
      /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-label", children: ca.label }),
      /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-value", children: fmt(value.cutoff, ca.formatValue) })
    ] }),
    /* @__PURE__ */ jsxs38("div", { className: "tweakers-move-filter-readout", "data-side": "resonance", children: [
      /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-label", children: ra.label }),
      /* @__PURE__ */ jsx43("span", { className: "tweakers-move-dial-value", children: fmt(value.resonance, ra.formatValue) })
    ] })
  ] });
}
...
function boldColons(text) {
  ...
  return text.split(":").flatMap(
    (part, i) => i === 0 ? [part] : [/* @__PURE__ */ jsx44("span", { className: "tweakers-move-volume-sep", children: ":" }, `sep-${i}`), part]
  );
}
...
function MovePanel({ theme = "system", productionEnabled = isDevDefault, panels: only, dock = "viewport" }) {
  ...
  const headerCluster = volume && /* @__PURE__ */ jsx44("div", { className: "tweakers-move-actions", children: /* @__PURE__ */ jsxs39("div", { className: "tweakers-move-volume", children: [
    /* @__PURE__ */ jsx44("span", { className: "tweakers-move-volume-tick", style: { background: MOVE_TRACK_COLORS[0] } }),
    volume.label && volumeReading != null && /* @__PURE__ */ jsx44("span", { className: "tweakers-move-volume-label", children: volume.label }),
    /* @__PURE__ */ jsx44("span", { className: "tweakers-move-volume-value", children: boldColons(volumeReading ?? volume.label ?? "") })
  ] }) });
  const content = /* @__PURE__ */ jsx44("div", { className: "tweakers-root tweakers-move-root", "data-theme": theme, "data-dock": dock, children: /* @__PURE__ */ jsxs39("div", { className: "tweakers-move", "data-dock": dock, "data-overlay": composition ? true : void 0, children: [
    composition && modSettings && /* @__PURE__ */ jsx44(
      MoveCurveComposer,
      {
    ...
    /* @__PURE__ */ jsxs39("div", { className: "tweakers-move-inner", style: { "--move-cols": visibleCols.length || MOVE_DIALS }, children: [
      /* @__PURE__ */ jsxs39("div", { className: "tweakers-move-tracks", children: [
        /* @__PURE__ */ jsx44("div", { className: "tweakers-move-tracks-group", children: pages.map((pg, i) => /* @__PURE__ */ jsxs39(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx44("span", { className: "tweakers-move-track-marker", style: { background: MOVE_TRACK_COLORS[i] } }),
              /* @__PURE__ */ jsx44("span", { className: "tweakers-move-track-label", children: pg.panel.name })
            ]
          },
          pg.panel.id
        )) }),
        /* @__PURE__ */ jsx44("div", { className: "tweakers-move-mods", children: surface.steps ? surface.steps.map((s) => /* @__PURE__ */ jsx44("span", { className: "tweakers-move-mod", title: `step ${s.step + 1}`, children: /* @__PURE__ */ jsx44(
          "span",
          {
            className: "tweakers-move-mod-dot",
            style: { background: s.color ?? "var(--move-text)", opacity: s.lit ? 1 : 0.25 }
          }
        ) }, s.step)) : ModulationStore.getSlots().map((slot) => /* @__PURE__ */ jsx44(MoveModCircle, { slot }, slot.index)) }),
        headerCluster
      ] }),
      visibleCols.length > 0 && /* @__PURE__ */ jsxs39("div", { className: "tweakers-move-grid", children: [
        /* @__PURE__ */ jsx44("div", { className: "tweakers-move-dials", children: visibleCols.map((i) => {
          if (isSpanContinuation(page, i)) return null;
          const meta = page.dials[i]?.type === "filter" ? page.dials[i] : dialAt(i);
          if (!meta) return /* @__PURE__ */ jsx44("div", { className: "tweakers-move-dial", "data-empty": "true" }, `empty-${i}`);
          ...
          if (meta.type === "filter") {
            ...
            return /* @__PURE__ */ jsxs39(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx44(MoveModRing, { panelId: page.panel.id, path: meta.path }),
                  /* @__PURE__ */ jsx44(MoveSlotFilterBody, { meta, value: fv, shape })
                ]
              },
              meta.path
            );
          ...
          if (meta.type === "xy") {
            ...
            return /* @__PURE__ */ jsxs39(
              "div",
              {
                ...
                children: [
                  valueFirst && /* @__PURE__ */ jsx44("span", { className: "tweakers-move-dial-sub", children: meta.label }),
                  /* @__PURE__ */ jsx44(MoveModRing, { panelId: page.panel.id, path: meta.path }),
                  /* @__PURE__ */ jsx44("div", { className: "tweakers-move-xy", children: preview ? /* @__PURE__ */ jsx44(
                    "svg",
                    {
                      ...
                      preserveAspectRatio: "none",
                      "aria-hidden": "true",
                      children: /* @__PURE__ */ jsx44("path", { d: previewPathData(preview.points) })
                    }
                  ) : /* @__PURE__ */ jsxs39(Fragment11, { children: [
                    gridN > 0 && /* @__PURE__ */ jsx44(
                      "span",
                      {
                    ...
                    /* @__PURE__ */ jsx44("span", { className: "tweakers-move-xy-line", "data-axis": "x", style: { top: `${pos.y * 100}%` } }),
                    /* @__PURE__ */ jsx44("span", { className: "tweakers-move-xy-line", "data-axis": "y", style: { left: `${pos.x * 100}%` } }),
                    /* @__PURE__ */ jsx44("span", { className: "tweakers-move-xy-dot", style: { left: `${pos.x * 100}%`, top: `${pos.y * 100}%` } })
                  ] }) }),
                  /* @__PURE__ */ jsxs39("div", { className: "tweakers-move-dial-readout", children: [
                    /* @__PURE__ */ jsx44("span", { className: "tweakers-move-dial-label", "data-long": meta.label.length > 9 || void 0, children: meta.label }),
                    /* @__PURE__ */ jsx44("span", { className: "tweakers-move-dial-value", children: preview ? preview.label : `${Math.round(pos.x * 100)}\xB7${Math.round((1 - pos.y) * 100)}` })
                  ] })
                ]
              },
              meta.path
          ...
          if (meta.type === "range") {
            ...
            return /* @__PURE__ */ jsxs39(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx44(MoveModRing, { panelId: page.panel.id, path: meta.path }),
                  /* @__PURE__ */ jsx44(MoveSlotRangeBody, { label: meta.label, value: rangeReading(meta), lo: pos.lo, hi: pos.hi })
                ]
              },
              meta.path
            );
          ...
          return /* @__PURE__ */ jsxs39(
            "div",
            {
              ...
              children: [
                (subbed || valueFirst) && /* @__PURE__ */ jsx44("span", { className: "tweakers-move-dial-sub", children: meta.label }),
                /* @__PURE__ */ jsx44(MoveModRing, { panelId: page.panel.id, path: meta.path }),
                /* @__PURE__ */ jsx44(
                  MoveSlotDefaultBody,
                  {
        ...
        Array.from({ length: PAD_ROWS }, (_, row) => row).filter((row) => appRowAt(row) !== null || padRows.slice(row).some((r) => r.length > 0)).map((row) => /* @__PURE__ */ jsx44("div", { className: "tweakers-move-pads", children: visibleCols.map((col) => {
          const appRow = appRowAt(row);
          if (appRow !== null) {
            const cell = padAt(col, appRow);
            if (!cell || cell.empty) {
              return /* @__PURE__ */ jsx44("div", { className: "tweakers-move-pad", "data-empty": "true" }, `app-${col}`);
            }
            return /* @__PURE__ */ jsxs39(
              "button",
              {
                ...
                children: [
                  ...
                  cell.label && /* @__PURE__ */ jsx44("span", { className: "tweakers-move-pad-title", children: cell.label })
                ]
              },
              `app-${col}`
            );
          ...
          if (!meta) return /* @__PURE__ */ jsx44("div", { className: "tweakers-move-pad", "data-empty": "true" }, `empty-${col}`);
          if (padRows[row] === page.toggles) {
            return /* @__PURE__ */ jsxs39(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx44("span", { className: "tweakers-move-pad-indicator" }),
                  /* @__PURE__ */ jsx44("span", { className: "tweakers-move-pad-title", children: meta.label })
                ]
              },
              meta.path
            );
          ...
          if (padRows[row] === page.actions) {
            return /* @__PURE__ */ jsx44(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx44("span", { className: "tweakers-move-pad-title", children: meta.label })
              },
              meta.path
            );
          }
          ...
          return /* @__PURE__ */ jsxs39(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx44(MoveModRing, { panelId: page.panel.id, path: meta.path, pad: true }),
                /* @__PURE__ */ jsx44("span", { className: "tweakers-move-pad-title", children: meta.label }),
                /* @__PURE__ */ jsxs39("span", { className: "tweakers-move-pad-reading", children: [
                  /* @__PURE__ */ jsx44("span", { className: "tweakers-move-pad-number", children: value.num }),
                  value.unit && /* @__PURE__ */ jsx44("span", { children: value.unit })
                ] })
              ]
            },
            meta.path
...
function MoveCurveComposer({
  ...
  return /* @__PURE__ */ jsx44("div", { className: "tweakers-move-curve", children: /* @__PURE__ */ jsx44(
    CurveComposer,
    {
      segments,
      direction,
...
function MoveActionButton({ kind, children, onPress, disabled, className }) {
  ...
  return /* @__PURE__ */ jsxs40(
    "button",
    {
      ...
      children: [
        kind === "capture" ? /* @__PURE__ */ jsx45("svg", { className: "tweakers-move-action-icon", width: "14", height: "14", viewBox: ICON_MOVE_CAPTURE.viewBox, fill: "none", children: /* @__PURE__ */ jsx45("path", { d: ICON_MOVE_CAPTURE.path, fill: "currentColor" }) }) : (
          ...
          /* @__PURE__ */ jsx45("svg", { className: "tweakers-move-action-icon", width: "12", height: "12", viewBox: ICON_MOVE_ENTER.viewBox, fill: "none", children: /* @__PURE__ */ jsx45("circle", { ...ICON_MOVE_ENTER.circle, fill: "currentColor" }) })
        ),
        children
      ]
    }
...
function WaveformVisualization({
  ...
  return /* @__PURE__ */ jsxs41("div", { className: "tweakers-waveform-viz-wrap", style: { width }, children: [
    /* @__PURE__ */ jsx46("canvas", { ref: canvasRef, className: "tweakers-waveform-viz", style: { width, height } }),
    !framingLoop && /* @__PURE__ */ jsxs41("div", { className: "tweakers-waveform-zoom", children: [
...
function MoveWaveform({
  ...
  const body = /* @__PURE__ */ jsx47(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs42("div", { className: "tweakers-move-wave-canvas", style: { height: `${boxHeight}px` }, children: [
        width > 0 && wave,
        children
      ] })
    }
  ...
  return createPortal9(
    /* @__PURE__ */ jsx47("div", { className: "tweakers-root tweakers-move-root", "data-theme": theme, "data-wave-dock": "true", children: body }),
    document.body
  );
}
...
import { Fragment as Fragment12, jsx as jsx48, jsxs as jsxs43 } from "react/jsx-runtime";
  ...
  return /* @__PURE__ */ jsxs43(Fragment12, { children: [
    ...
    /* @__PURE__ */ jsx48(
      "div",
      {
        ...
        title: barTitle,
        children: composite ? /* @__PURE__ */ jsx48(Fragment12, { children: width > 56 && /* @__PURE__ */ jsx48("span", { className: "tweakers-timeline-clip-duration", children: durationText }) }) : isSteps ? /* @__PURE__ */ jsxs43(Fragment12, { children: [
          steps.map((step) => {
