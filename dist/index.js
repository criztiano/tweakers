...
function MovePanel({ theme = "system", productionEnabled = isDevDefault, panels: only, dock = "viewport" }) {
  ...
  const [bendHeld, setBendHeld] = useState26(null);
  const bendRef = useRef31(null);
          ...
          if (meta.type === "toggle") {
            return /* @__PURE__ */ jsxs41(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx46(MoveModRing, { panelId: page.panel.id, path: meta.path }),
                  /* @__PURE__ */ jsx46(MoveSlotToggleBody, { label: meta.label, on: !!values[meta.path] })
                ]
              },
              meta.path
            );
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx46(
                    MoveSlotScopeBody,
                    {
                      ...
                      children: /* @__PURE__ */ jsx46(MoveScope, { index: modSettings.index })
                    }
                  )
                ]
              },
            ...
            return /* @__PURE__ */ jsxs41(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx46("div", { className: "tweakers-move-env-zones", children: stageDials.map(({ meta: m }) => /* @__PURE__ */ jsx46(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsx46(MoveModRing, { panelId: page.panel.id, path: m.path })
                    },
                    m.path
                  )) })
                ]
            ...
            return /* @__PURE__ */ jsxs41(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx46("span", { className: "tweakers-move-pad-title", children: "Curve" })
                ]
              },
              `bend-${bendStage}`
            );
...
function MoveScope({ index }) {
  ...
  return /* @__PURE__ */ jsx46(
    "svg",
    {
      ...
      preserveAspectRatio: "none",
      "aria-hidden": "true",
      children: /* @__PURE__ */ jsx46("path", { ref })
    }
  );
}
