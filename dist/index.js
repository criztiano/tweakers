...
import { useEffect as useEffect8, useId, useRef as useRef8, useState as useState6, useSyncExternalStore as useSyncExternalStore2, useCallback as useCallback2 } from "react";
...
import { useCallback, useEffect as useEffect2, useRef as useRef2, useState as useState2, useSyncExternalStore } from "react";
...
function WaveformVisualization({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "tweakers-waveform-viz-wrap", style: { width }, children: [
    /* @__PURE__ */ jsx("canvas", { ref: canvasRef, className: "tweakers-waveform-viz", style: { width, height } }),
    !framingLoop && /* @__PURE__ */ jsxs("div", { className: "tweakers-waveform-zoom", children: [
      zoom > 1 && /* @__PURE__ */ jsx("button", { type: "button", "aria-label": "Zoom out", onClick: () => setZoom((z) => Math.max(1, z / 2)), children: /* @__PURE__ */ jsx("svg", { viewBox: "0 0 16 16", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M3.5 8h9", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" }) }) }),
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsx("svg", { viewBox: "0 0 16 16", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M8 3.5v9M3.5 8h9", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" }) })
        }
      )
    ] })
  ] });
...
var MoveWaveformStoreClass = class {
  ...
  register() {
    TweakStore2.noteMoveKitUse("waveform");
...
function MoveWaveform({
  ...
  const [dockBottom, setDockBottom] = useState2(0);
  const [mounted, setMounted] = useState2(false);
  const seekRef = useRef2(onSeek);
  seekRef.current = onSeek;
  const loopRef = useRef2(onLoopChange);
  ...
  const lastSent = useRef2({ position: state2.position, loop: state2.loop });
  useEffect2(() => {
  ...
  const body = /* @__PURE__ */ jsx2(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs2("div", { className: "tweakers-move-wave-canvas", style: { height: `${boxHeight}px` }, children: [
        width > 0 && wave,
        children
      ] })
    }
  ...
  return createPortal(
    /* @__PURE__ */ jsx2("div", { className: "tweakers-root tweakers-move-root", "data-theme": theme, "data-wave-dock": "true", children: body }),
    document.body
  );
}
...
function CurveComposer({
  ...
  const liveRef = useRef3({ composition, samplers, getPhase, phase, mode, triggerSteps });
  liveRef.current = { composition, samplers, getPhase, phase, mode, triggerSteps };
  const onTriggerRef = useRef3(onTrigger);
  onTriggerRef.current = onTrigger;
  const svgRef = useRef3(null);
  const seriesPlayheadRef = useRef3(null);
  const seriesDotRef = useRef3(null);
  const driverPlayheadRef = useRef3(null);
  const prevTrigValue = useRef3(Number.NaN);
  ...
  const renderLaneGrid = (rect) => {
    ...
    for (let i = 1; i < n; i++) {
      const gx = i / n * W;
      lines.push(
        /* @__PURE__ */ jsx3("line", { x1: gx, y1: rect.y, x2: gx, y2: rect.y + rect.h, className: "tweakers-cc-grid" }, `g-${rect.y}-${i}`)
      );
    }
    return lines;
  };
  const renderLaneBg = (rect, key) => /* @__PURE__ */ jsx3("rect", { className: "tweakers-cc-lane", x: rect.x, y: rect.y, width: rect.w, height: rect.h, rx: 8 }, key);
  const diagonal = (rect, span, key) => {
    const d = diagonalLine(rect, span, W);
    return /* @__PURE__ */ jsx3("line", { className: "tweakers-cc-diagonal", x1: d.x1, y1: d.y1, x2: d.x2, y2: d.y2 }, key);
  };
  return /* @__PURE__ */ jsx3("div", { className: "tweakers-cc-wrap", style: { width: W }, children: /* @__PURE__ */ jsxs3(
    "svg",
    {
      ref: svgRef,
      ...
      children: [
        ...
        segments.map((seg, i) => {
          ...
          return /* @__PURE__ */ jsxs3("g", { children: [
            ...
            /* @__PURE__ */ jsx3("path", { className: "tweakers-cc-curve", d: curvePath(seg, mainRect, span, W) }),
            /* @__PURE__ */ jsx3("text", { className: "tweakers-cc-label", x: (span[0] + span[1]) * 0.5 * W, y: mainRect.y + 13, children: seg.type })
          ] }, `seg-${i}`);
        }),
        gap > 0 && timelineSlots(segments, gap).filter((slot) => slot.kind === "gap" && slot.b > slot.a).map((slot) => /* @__PURE__ */ jsx3(
          "path",
          {
        ...
        interior.map((bx, i) => /* @__PURE__ */ jsx3(
          "line",
          {
        ...
        /* @__PURE__ */ jsx3("line", { ref: seriesPlayheadRef, className: "tweakers-cc-playhead", x1: 0, y1: mainRect.y, x2: 0, y2: mainRect.y + mainRect.h, style: { stroke: playheadColor } }),
        /* @__PURE__ */ jsx3("circle", { ref: seriesDotRef, className: "tweakers-cc-dot", cx: 0, cy: mapY(mainRect, 0), r: 3, style: { fill: playheadColor } }),
        driverRect && /* @__PURE__ */ jsxs3(Fragment, { children: [
          renderLaneBg(driverRect, "driver-bg"),
          renderLaneGrid(driverRect),
          hover?.kind === "driver" && !drag && /* @__PURE__ */ jsx3("rect", { className: "tweakers-cc-seg-hover", x: 0, y: driverRect.y, width: W, height: driverRect.h, rx: 8 }),
          diagonal(driverRect, [0, 1], "driver-diag"),
          /* @__PURE__ */ jsx3("path", { className: "tweakers-cc-curve tweakers-cc-curve-driver", d: curvePath(driver, driverRect, [0, 1], W) }),
          /* @__PURE__ */ jsxs3("text", { className: "tweakers-cc-label", x: W * 0.5, y: driverRect.y + 13, children: [
            "driver \xB7 ",
            driver.type
          ] }),
          /* @__PURE__ */ jsx3("line", { ref: driverPlayheadRef, className: "tweakers-cc-playhead", x1: 0, y1: driverRect.y, x2: 0, y2: driverRect.y + driverRect.h, style: { stroke: playheadColor } })
        ] })
      ]
    }
  ) });
...
function MoveSlotNumericBody({ label, value, drawing }) {
  return /* @__PURE__ */ jsxs4(Fragment2, { children: [
    ...
    /* @__PURE__ */ jsxs4("svg", { className: "tweakers-move-visual", viewBox: "0 0 100 60", "aria-hidden": "true", children: [
      drawing.kind === "opacity" && /* @__PURE__ */ jsxs4(Fragment2, { children: [
        /* @__PURE__ */ jsx4("circle", { className: "tweakers-move-visual-guide", cx: "40", cy: "30", r: "18" }),
        /* @__PURE__ */ jsx4("circle", { className: "tweakers-move-visual-guide", cx: "60", cy: "30", r: "18" }),
        /* @__PURE__ */ jsx4("circle", { className: "tweakers-move-visual-solid", cx: "60", cy: "30", r: "18", opacity: drawing.alpha })
      ] }),
      drawing.kind === "blur" && /* @__PURE__ */ jsx4(
        "circle",
        {
      ...
      drawing.kind === "pan" && /* @__PURE__ */ jsxs4(Fragment2, { children: [
        /* @__PURE__ */ jsx4("path", { className: "tweakers-move-visual-guide", d: "M16 30H84M50 12V48" }),
        /* @__PURE__ */ jsx4("path", { className: "tweakers-move-visual-line", d: `M50 30H${16 + drawing.position * 68}` }),
        /* @__PURE__ */ jsx4(
          "circle",
          {
        ...
        /* @__PURE__ */ jsx4("text", { x: "5", y: "30", dominantBaseline: "central", children: "L" }),
        /* @__PURE__ */ jsx4("text", { x: "95", y: "30", dominantBaseline: "central", children: "R" })
      ] }),
      drawing.kind === "stereo-width" && /* @__PURE__ */ jsxs4(Fragment2, { children: [
        /* @__PURE__ */ jsx4("path", { className: "tweakers-move-visual-guide", d: "M50 13V47" }),
        drawing.unity !== null && /* @__PURE__ */ jsxs4("g", { className: "tweakers-move-visual-reference", children: [
          /* @__PURE__ */ jsx4("ellipse", { cx: 50 - drawing.unity * 28, cy: "30", rx: "12", ry: "17" }),
          /* @__PURE__ */ jsx4("ellipse", { cx: 50 + drawing.unity * 28, cy: "30", rx: "12", ry: "17" })
        ] }),
        /* @__PURE__ */ jsxs4("g", { className: "tweakers-move-visual-lobes", children: [
          /* @__PURE__ */ jsx4("ellipse", { cx: 50 - drawing.separation * 28, cy: "30", rx: "12", ry: "17" }),
          /* @__PURE__ */ jsx4("ellipse", { cx: 50 + drawing.separation * 28, cy: "30", rx: "12", ry: "17" })
        ] })
      ] }),
      drawing.kind === "pitch" && /* @__PURE__ */ jsxs4("g", { children: [
        /* @__PURE__ */ jsx4("path", { className: "tweakers-move-visual-guide", d: "M8 30H92M8 25V35M29 27V33M50 25V35M71 27V33M92 25V35" }),
        drawing.zero !== null && /* @__PURE__ */ jsx4("path", { className: "tweakers-move-visual-reference", d: `M${8 + drawing.zero * 84} 12V48` }),
        /* @__PURE__ */ jsx4("path", { className: "tweakers-move-visual-line", d: `M${8 + (drawing.zero ?? 0) * 84} 30H${8 + drawing.position * 84}` }),
        /* @__PURE__ */ jsx4(
          "path",
          {
    ...
    /* @__PURE__ */ jsx4("span", { className: "tweakers-move-dial-option tweakers-move-visual-value", children: value })
  ] });
}
function MoveSlotPlaybackDrawing({ mode }) {
  ...
  return /* @__PURE__ */ jsx4(
    "svg",
    {
      ...
      "aria-hidden": "true",
      children: /* @__PURE__ */ jsx4("g", { transform: mode === "reverse" ? "translate(24 0) scale(-1 1)" : void 0, children: LUCIDE_ICONS[icon].map((d) => /* @__PURE__ */ jsx4("path", { d }, d)) })
    }
  );
}
...
function MoveSlotGlyph({ name, className }) {
  ...
  return /* @__PURE__ */ jsx6(
    "svg",
    {
      ...
      strokeLinejoin: "round",
      "aria-hidden": "true",
      children: paths.map((d) => /* @__PURE__ */ jsx6("path", { d }, d))
    }
  );
}
...
function MoveSlotShape({ d, className = "tweakers-move-dial-shape" }) {
  return /* @__PURE__ */ jsx6("svg", { className, viewBox: "0 0 100 100", preserveAspectRatio: "none", "aria-hidden": "true", children: /* @__PURE__ */ jsx6("path", { d }) });
}
function MoveSlotDefaultBody({
  ...
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    /* @__PURE__ */ jsx6(MoveSlotReadout, { label, value }),
    /* @__PURE__ */ jsxs6("div", { className: "tweakers-move-dial-bar", children: [
      /* @__PURE__ */ jsx6(
        "div",
        {
      ...
      atOrigin && /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-zero", style: { left: `${originPct}%` } })
    ] })
  ] });
}
...
function MoveSlotEnumBody({
  ...
  if (playback || shape || glyph || scoped) {
    return /* @__PURE__ */ jsxs6(Fragment3, { children: [
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-tag", children: label }),
      playback && /* @__PURE__ */ jsx6(MoveSlotPlaybackDrawing, { mode: playback }),
      !playback && shape && /* @__PURE__ */ jsx6(MoveSlotShape, { d: shape }),
      !playback && glyph && /* @__PURE__ */ jsx6(MoveSlotGlyph, { name: glyph, className: "tweakers-move-dial-icon" }),
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-option", children: optionLabel }),
      /* @__PURE__ */ jsx6("div", { className: "tweakers-move-dial-bar", children: /* @__PURE__ */ jsx6("div", { className: "tweakers-move-dial-enum", children: options.map((opt, j) => /* @__PURE__ */ jsx6(
        "span",
        {
  ...
  return /* @__PURE__ */ jsxs6(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-head", children: label }),
        /* @__PURE__ */ jsx6(
          ListScreen,
          {
...
function MoveSlotXYBody({ label, value, position, gridN, shape = null }) {
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    /* @__PURE__ */ jsx6("div", { className: "tweakers-move-xy", children: shape !== null ? /* @__PURE__ */ jsx6(MoveSlotShape, { d: shape, className: "tweakers-move-xy-curve" }) : /* @__PURE__ */ jsxs6(Fragment3, { children: [
      gridN > 0 && /* @__PURE__ */ jsx6("span", { className: "tweakers-move-xy-grid", style: {
        "--tweak-xy-grid-step-x": `${100 / gridN}%`,
        "--tweak-xy-grid-step-y": `${100 / gridN}%`
      } }),
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-xy-line", "data-axis": "x", style: { top: `${position.y * 100}%` } }),
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-xy-line", "data-axis": "y", style: { left: `${position.x * 100}%` } }),
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-xy-dot", style: { left: `${position.x * 100}%`, top: `${position.y * 100}%` } })
    ] }) }),
    /* @__PURE__ */ jsx6(MoveSlotReadout, { label, value })
  ] });
}
function MoveSlotDisplay({ children }) {
  return /* @__PURE__ */ jsx6("div", { className: "tweakers-move-slot-display", children });
}
function MoveSlotDisplayFoot({ label, value }) {
  return /* @__PURE__ */ jsxs6("div", { className: "tweakers-move-slot-foot", children: [
    /* @__PURE__ */ jsx6("span", { className: "tweakers-move-slot-foot-label", children: label }),
    /* @__PURE__ */ jsx6("span", { className: "tweakers-move-slot-foot-value", children: value })
  ] });
}
function MoveSlotTransferBody({ label, value, shape, point }) {
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    /* @__PURE__ */ jsxs6(MoveSlotDisplay, { children: [
      /* @__PURE__ */ jsx6(MoveSlotShape, { d: shape, className: "tweakers-move-slot-shape" }),
      point && /* @__PURE__ */ jsx6(
        "span",
        {
...
function MoveSlotDialBody({ label, value, bearing, origin }) {
  ...
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    /* @__PURE__ */ jsx6(MoveSlotDisplay, { children: /* @__PURE__ */ jsxs6("svg", { className: "tweakers-move-slot-needle", viewBox: "-12 -12 24 24", "aria-hidden": "true", children: [
      /* @__PURE__ */ jsx6("circle", { className: "tweakers-move-needle-face", cx: "0", cy: "0", r: "8.5" }),
      /* @__PURE__ */ jsx6("path", { className: "tweakers-move-needle-sweep", d: arcPath(origin, bearing, 8.5) }),
      /* @__PURE__ */ jsx6(
        "line",
        {
...
function MoveSlotRangeBody({
  ...
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    /* @__PURE__ */ jsx6(MoveSlotReadout, { label, value }),
    /* @__PURE__ */ jsx6("div", { className: "tweakers-move-dial-bar", children: /* @__PURE__ */ jsxs6("div", { className: "tweakers-move-dial-range", children: [
      /* @__PURE__ */ jsx6(
        "div",
        {
      ...
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-handle", style: { left: `${lo * 100}%` } }),
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-handle", style: { left: `${hi * 100}%` } })
    ] }) })
  ] });
}
function MoveSlotFilterBody({
  ...
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    /* @__PURE__ */ jsx6("div", { className: "tweakers-move-filter-display", children: shape && /* @__PURE__ */ jsx6(MoveSlotShape, { d: shape, className: "tweakers-move-filter-shape" }) }),
    /* @__PURE__ */ jsxs6("div", { className: "tweakers-move-filter-readout", "data-side": "cutoff", children: [
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-label", children: ca.label }),
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-value", children: fmt(value.cutoff, ca.formatValue) })
    ] }),
    /* @__PURE__ */ jsxs6("div", { className: "tweakers-move-filter-readout", "data-side": "resonance", children: [
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-label", children: ra.label }),
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-value", children: fmt(value.resonance, ra.formatValue) })
    ] })
  ] });
}
function MoveSlotColorBody({ label, color, hue: hue2 }) {
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-head", children: label }),
    /* @__PURE__ */ jsx6("span", { className: "tweakers-move-color-swatch", "aria-hidden": "true", children: /* @__PURE__ */ jsx6("span", { style: { background: color } }) }),
    /* @__PURE__ */ jsxs6("span", { className: "tweakers-move-color-reading", children: [
      Math.round(hue2),
      "\xB0"
    ] })
  ] });
...
function MoveSlotEnvBody({
  ...
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    /* @__PURE__ */ jsxs6("div", { className: "tweakers-move-env-display", children: [
      /* @__PURE__ */ jsx6(MoveSlotShape, { d, className: "tweakers-move-env-shape" }),
      joints.map((j) => /* @__PURE__ */ jsx6(
        "span",
        {
    ...
    stages.map((s) => /* @__PURE__ */ jsxs6("div", { className: "tweakers-move-env-readout", "data-stage": s.stage, children: [
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-label", children: s.label }),
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-value", children: s.value })
    ] }, s.stage))
  ] });
}
function MoveSlotScopeBody({
  ...
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    /* @__PURE__ */ jsx6("div", { className: "tweakers-move-scope-display", children }),
    /* @__PURE__ */ jsx6(MoveSlotReadout, { label, value }),
    /* @__PURE__ */ jsx6("div", { className: "tweakers-move-dial-bar", children: /* @__PURE__ */ jsx6("div", { className: "tweakers-move-dial-fill", style: { width: `${pct}%` } }) })
  ] });
}
function MoveSlotToggleBody({ label, checked, icon, onIcon, offIcon }) {
  ...
  if (!icon) {
    return /* @__PURE__ */ jsxs6(Fragment3, { children: [
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-toggle-indicator", "data-on": checked || void 0 }),
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-dial-toggle-label", children: label })
    ] });
  }
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    /* @__PURE__ */ jsxs6("span", { className: "tweakers-move-toggle-picture", "aria-hidden": "true", children: [
      /* @__PURE__ */ jsx6(MoveSlotIcon, { icon, className: "tweakers-move-toggle-icon" }),
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-toggle-badge", children: badge ? /* @__PURE__ */ jsx6(MoveSlotIcon, { icon: badge, className: "tweakers-move-toggle-state-icon" }) : /* @__PURE__ */ jsx6(MoveSlotBadge, { on: checked }) })
    ] }),
    /* @__PURE__ */ jsx6("span", { className: "tweakers-move-toggle-label", children: label })
  ] });
}
function MoveSlotIcon({ icon, className }) {
  if (LUCIDE_ICONS[icon]) return /* @__PURE__ */ jsx6(MoveSlotGlyph, { name: icon, className });
...
function MoveSlotBadge({ on }) {
  return /* @__PURE__ */ jsx6(
    "svg",
    {
      ...
      fill: "currentColor",
      "aria-hidden": "true",
      children: /* @__PURE__ */ jsx6("path", { d: on ? ICON_BADGE_ON : ICON_BADGE_OFF })
    }
  );
}
...
function MovePadValueBody({ label, value, unit, children }) {
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    ...
    /* @__PURE__ */ jsxs6("span", { className: "tweakers-move-pad-reading", children: [
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-pad-number", children: value }),
      unit && /* @__PURE__ */ jsx6("span", { children: unit })
    ] })
  ] });
}
function MovePadWaveBody({ label, percent }) {
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    ...
    /* @__PURE__ */ jsx6("span", { className: "tweakers-move-pad-title", children: label }),
    /* @__PURE__ */ jsxs6("span", { className: "tweakers-move-pad-reading", children: [
      /* @__PURE__ */ jsx6("span", { className: "tweakers-move-pad-number", children: percent }),
...
function MovePadAppBody({ label, color }) {
  return /* @__PURE__ */ jsxs6(Fragment3, { children: [
    ...
    label && /* @__PURE__ */ jsx6("span", { className: "tweakers-move-pad-title", children: label })
  ] });
}
...
function ModRing({
  ...
  return /* @__PURE__ */ jsxs7(
    "svg",
    {
      ...
      "aria-hidden": "true",
      children: [
        /* @__PURE__ */ jsx7("circle", { className: "tweakers-mod-ring-track", cx: "8", cy: "8", r: MOD_RING_RADIUS }),
        /* @__PURE__ */ jsx7(
          "circle",
          {
            ref: arcRef,
...
var used = () => TweakStore4.noteMoveKitUse("surface");
...
var MoveColorStoreClass = class {
  ...
  gradient(panelId, path) {
    const v = TweakStore6.getValue(panelId, path);
  ...
  moveStop(panelId, path, index, position) {
    ...
    if (!g || TweakStore6.isDisabled(panelId, path) || !Number.isFinite(position)) return;
    ...
    TweakStore6.updateValue(panelId, path, {
      ...g,
  ...
  hexAt(panelId, path, stop) {
    ...
    return String(TweakStore6.getValue(panelId, path) ?? "#ff0000");
  }
  ...
  updateStop(panelId, path, stop, patch2) {
    ...
    if (g && stop !== null) TweakStore6.updateValue(panelId, path, setStopColor(g, stop, hex));
    else TweakStore6.updateValue(panelId, path, hex);
    this.notify();
  }
  setHue(h) {
...
function MoveColorSlot({ panelId, meta, active, open: open2, latched = false }) {
  ...
  return /* @__PURE__ */ jsx8(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx8(MoveSlotColorBody, { label: meta.label, color: String(TweakStore7.getValue(panelId, meta.path)), hue: color.h })
    }
  );
}
...
function MoveColorSteps({ color, disabled = false }) {
  ...
  return /* @__PURE__ */ jsx8("div", { className: "tweakers-move-color-steps", role: "group", "aria-label": "Color opacity sequencer", children: Array.from({ length: MOVE_COLOR_STEPS }, (_, step) => /* @__PURE__ */ jsx8(
    "button",
    {
      type: "button",
      ...
      children: /* @__PURE__ */ jsx8("span", { style: { opacity: 0.15 + step / (MOVE_COLOR_STEPS - 1) * 0.85 } })
    },
    step
  )) });
}
...
function MovePaletteScreen({ kept = null, children }) {
  ...
  return /* @__PURE__ */ jsxs8(
    "div",
    {
      ...
      children: [
        children,
        kept && !rows.length && /* @__PURE__ */ jsx8("span", { className: "tweakers-move-palette-empty", children: "No matches" }),
...
var MoveFunctionsClass = class {
  ...
  attach(name, handler, options) {
    ...
    TweakStore8.noteMoveKitUse("functions");
...
function ChipGlyph({ glyph }) {
  return /* @__PURE__ */ jsxs9("svg", { className: "tweakers-move-chip-icon", width: glyph.size, height: glyph.size, viewBox: glyph.viewBox, fill: "none", children: [
    ...
    glyph.fills?.map((d) => /* @__PURE__ */ jsx9("path", { d, fill: "currentColor" }, d)),
    glyph.circles?.map((c) => /* @__PURE__ */ jsx9("circle", { ...c, fill: "currentColor" }, `${c.cx},${c.cy}`)),
...
function Chip({ chip }) {
  ...
  const flashTimer = useRef7(void 0);
  useEffect7(() => {
...
function MoveFunctionChips({ className }) {
  ...
  return /* @__PURE__ */ jsx9("div", { className: className ? `tweakers-move-chips ${className}` : "tweakers-move-chips", children: chips.map((chip) => /* @__PURE__ */ jsx9(Chip, { chip }, chip.name)) });
}
...
var MovePresetStoreClass = class {
  ...
  items(panelId) {
    const provider = TweakStore9.getPresetProvider(panelId);
    if (provider) return provider.presets.map((p) => ({ id: p.id, label: p.label }));
    return TweakStore9.getPresets(panelId).map((p) => ({ id: p.id, label: p.name }));
  }
  /** Play a row's values without recording them — the browsing preview. */
  applyPreview(id) {
    const view = this.view;
    if (!view || !id || !this.previewEnabled || !this.original) return;
    const preset = TweakStore9.getPresets(view.panelId).find((p) => p.id === id);
    if (preset) TweakStore9.previewValues(view.panelId, preset.values);
  }
  open(panelId) {
    this.clearTimers();
    const active = TweakStore9.getActivePresetId(panelId);
    const items = this.items(panelId);
    const cursor = (active && items.some((i) => i.id === active) ? active : items[0]?.id) ?? null;
    this.original = TweakStore9.getPresetProvider(panelId) ? null : { ...TweakStore9.getValues(panelId) };
  ...
  cancel() {
    ...
    if (this.original) TweakStore9.previewValues(view.panelId, this.original);
  ...
  compareStart() {
    ...
    TweakStore9.previewValues(view.panelId, this.original);
    this.notify();
  }
  ...
  choose(id) {
    ...
    if (!this.items(view.panelId).some((i) => i.id === id)) return;
    const provider = TweakStore9.getPresetProvider(view.panelId);
    if (provider) void provider.onSelect(id);
    else TweakStore9.loadPreset(view.panelId, id);
  ...
  commitSave(name) {
    ...
    const provider = TweakStore9.getPresetProvider(saving.panelId);
    if (provider) void provider.onCreate(label);
    else TweakStore9.savePreset(saving.panelId, label);
    this.saving = null;
    this.notify();
  }
};
...
function MovePanel({ theme = "system", productionEnabled = isDevDefault, panels: only, dock = "viewport", scroll = false, headerStart, settings, functionChips = "clock" }) {
  ...
  const read = useCallback2(() => {
    if (onlyKey === void 0) return TweakStore10.selectPanels();
    const requested = JSON.parse(onlyKey);
    const registered = TweakStore10.getPanels("panel");
    return requested.map((key) => registered.find((panel) => panel.id === key || panel.name === key)).filter((panel) => panel !== void 0);
  }, [onlyKey]);
  useEffect8(() => {
    setMounted(true);
    setPanels(read());
    return TweakStore10.subscribeGlobal(() => setPanels(read()));
  }, [read]);
  const settingsKey = settings === void 0 ? void 0 : JSON.stringify(Array.isArray(settings) ? settings : [settings]);
  const settingsRooms = settingsKey === void 0 ? [] : JSON.parse(settingsKey).map((key) => TweakStore10.getPanels("panel").find((p) => p.id === key || p.name === key)).filter((p) => p !== void 0);
  ...
  const settingsPanel = modSettings ? TweakStore10.getPanel(modSettings.panelId) : void 0;
  const modLayout = settingsPanel ? ModulationStore2.getSettingsLayout() : null;
  const [roomTrack, setRoomTrack] = useState6(0);
  ...
  useSyncExternalStore2(MoveSearchStore.subscribe, MoveSearchStore.getVersion, () => 0);
  const search = MoveSearchStore.getView();
  const screenShown = useRef8(false);
  useEffect8(() => {
    const onSearch = (e) => {
  ...
  const values = useSyncExternalStore2(
    useCallback2((cb) => pageId ? TweakStore10.subscribe(pageId, cb) : () => {
    }, [pageId]),
    () => pageId ? TweakStore10.getValues(pageId) : void 0,
    () => void 0
  );
  const [, bumpControlState] = useState6(0);
  useEffect8(
    () => pageId ? TweakStore10.subscribeControlState(pageId, () => bumpControlState((n) => n + 1)) : void 0,
    [pageId]
  );
  ...
  const surface = useSyncExternalStore2(
  ...
  const roomIdsRef = useRef8(roomIds);
  roomIdsRef.current = roomIds;
  const sawSettings = useRef8(false);
  const sawRoom = useRef8(false);
  useEffect8(() => {
    const onPage = (e) => {
  ...
  const dialFromKeyboard = (e, meta) => {
    if (e.altKey || e.ctrlKey || e.metaKey || TweakStore10.isDisabled(page.panel.id, meta.path)) return;
    const next = moveKeyboardValue(meta, values[meta.path], e.key, e.shiftKey);
    if (next === null) return;
    e.preventDefault();
    e.stopPropagation();
    armMod(meta.path);
    TweakStore10.updateValue(page.panel.id, meta.path, next);
  };
  const dialFromPointer = (e, meta) => {
    ...
    TweakStore10.updateValue(page.panel.id, meta.path, denormalizeDial(meta, v01));
  };
  const xyFromPointer = (e, meta) => {
    ...
    TweakStore10.updateValue(page.panel.id, meta.path, {
  ...
  const transferFromPointer = (e, meta, down) => {
    ...
    TweakStore10.updateValue(page.panel.id, meta.path, { points: movePoint(points, index, x, y) });
  };
  const needleFromPointer = (e, meta) => {
    ...
    if (next !== null) TweakStore10.updateValue(page.panel.id, meta.path, next);
  };
  const rampFromPointer = (e, meta, down) => {
    ...
    TweakStore10.updateValue(page.panel.id, meta.path, { ...g, stops });
  };
  const xyRelease = (meta) => {
    ...
    const xa = resolveAxis(meta.xAxis);
    const ya = resolveAxis(meta.yAxis);
    TweakStore10.updateValue(page.panel.id, meta.path, normalizeValue(centerValue(xa, ya), xa, ya, !!meta.snap));
  };
  const rangeFromPointer = (e, meta, down) => {
    ...
    TweakStore10.updateValue(page.panel.id, meta.path, denormalizeRangeDial(meta, next.lo, next.hi));
  };
  ...
  const enumFromPointer = (e, meta) => {
    ...
    TweakStore10.updateValue(page.panel.id, meta.path, denormalizeEnumDial(meta, v01));
  };
  ...
  const headerCluster = (volume || functionChips === "clock") && /* @__PURE__ */ jsxs10("div", { className: "tweakers-move-actions", children: [
    functionChips === "clock" && /* @__PURE__ */ jsx10(MoveFunctionChips, {}),
    volume && /* @__PURE__ */ jsxs10("div", { className: "tweakers-move-volume", children: [
      /* @__PURE__ */ jsx10("span", { className: "tweakers-move-volume-tick", style: { background: MOVE_TRACK_COLORS[0] } }),
  ...
  const content = /* @__PURE__ */ jsx10("div", { className: "tweakers-root tweakers-move-root", "data-theme": theme, "data-dock": dock, children: /* @__PURE__ */ jsxs10("div", { ref: panelRef, className: "tweakers-move", "data-dock": dock, "data-settings": settingsOpen || void 0, "data-overlay": composition || audioWave != null || color || presetSave ? true : void 0, children: [
    colorMeta && /* @__PURE__ */ jsx10(MoveColorDisplay, { panelId: page.panel.id, meta: colorMeta, anchor: panelRef, theme }),
    presetSave && /* @__PURE__ */ jsx10(MovePresetSaveInput, { suggested: presetSave.suggested }),
    composition && modSettings && /* @__PURE__ */ jsx10(
      MoveCurveComposer,
      {
    ...
    audioWave != null && /* @__PURE__ */ jsx10(MoveAudioWave, { index: audioWave, theme }),
    /* @__PURE__ */ jsxs10(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs10("div", { className: "tweakers-move-tracks", children: [
              ...
              settingsOpen && /* @__PURE__ */ jsxs10("div", { className: "tweakers-move-settings-title", children: [
                ...
                roomPages.length > 1 ? /* @__PURE__ */ jsx10("div", { className: "tweakers-move-pages", role: "tablist", "aria-label": "Settings pages", children: roomPages.map((pg, i) => /* @__PURE__ */ jsxs10(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx10("span", { className: "tweakers-move-track-marker", style: { background: MOVE_TRACK_COLORS[i] } }),
            ...
            /* @__PURE__ */ jsx10("div", { className: "tweakers-move-mods", children: settingsOpen ? null : color && colorMeta ? /* @__PURE__ */ jsx10(MoveColorSteps, { color, disabled: TweakStore10.isDisabled(page.panel.id, colorMeta.path) }) : surface.steps === null ? ModulationStore2.getSlots().map((slot) => /* @__PURE__ */ jsx10(MoveModCircle, { slot }, slot.index)) : null }),
          ...
          /* @__PURE__ */ jsxs10(
            "div",
            {
              ...
              children: [
                screen && /* @__PURE__ */ jsxs10("div", { className: "tweakers-move-wheel-screen", role: "group", "aria-label": screen.title ?? "Wheel selection", "data-search": screenSearch ? true : void 0, children: [
                  screenSearch && /* @__PURE__ */ jsx10(MoveSearchBar, { view: screenSearch }),
                  /* @__PURE__ */ jsx10(
                    ListScreen,
                    {
                      items: searchedRows(
                ...
                (visibleCols.length > 0 || shownPadRows.length > 0) && /* @__PURE__ */ jsxs10(
                  "div",
                  {
                    ...
                    children: [
                      presetScreen && /* @__PURE__ */ jsx10(MovePresetScreen, { view: presetScreen, search: presetSearch }),
                      paletteScreen && /* @__PURE__ */ jsx10(MovePaletteScreen, { kept: paletteSearch ? moveSearchFilter(["All colors", ...MOVE_COLOR_PALETTES.map((p) => p.name)], paletteSearch.query) : null, children: paletteSearch && /* @__PURE__ */ jsx10(MoveSearchBar, { view: paletteSearch }) }),
                        ...
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsx10("div", { className: "tweakers-move-dials", "data-scroll": stripMode || void 0, children: visibleCols.map((i) => {
                              ...
                              const disabled = TweakStore10.isDisabled(page.panel.id, meta.path);
                              ...
                              if (meta.type === "color") return /* @__PURE__ */ jsx10(MoveColorSlot, { panelId: page.panel.id, meta, active, open: colorMeta?.path === meta.path, latched: meta !== page.dials[i] && chipLatched(i, meta) }, meta.path);
                              if (meta.type === "filter") {
                                ...
                                return /* @__PURE__ */ jsxs10(
                                  "div",
                                  {
                                    ...
                                    onPointerUp: () => {
                                      ...
                                      setDragPath(null);
                                      fineRef.current = null;
                                      if (tapped && editable && !TweakStore10.isDisabled(page.panel.id, meta.path)) {
                              ...
                              if (isEnumDial(meta)) {
                                ...
                                return /* @__PURE__ */ jsxs10(
                                  "div",
                                  {
                                    ...
                                    "data-active": active || void 0,
                                    onPointerDown: (e) => {
                                      if (TweakStore10.isDisabled(page.panel.id, meta.path)) return;
                                      try {
                                        e.currentTarget.setPointerCapture(e.pointerId);
                                      } catch {
                                      }
                                    ...
                                    onPointerMove: (e) => {
                                      if (!TweakStore10.isDisabled(page.panel.id, meta.path) && dragPath === meta.path) enumFromPointer(e, meta);
                                    },
                                    onPointerUp: () => {
                                      setDragPath(null);
                                      fineRef.current = null;
                              ...
                              if (meta.type === "toggle") {
                                ...
                                return /* @__PURE__ */ jsxs10(
                                  "button",
                                  {
                                    ...
                                    disabled,
                                    onClick: () => {
                                      if (!TweakStore10.isDisabled(page.panel.id, meta.path)) {
                                        TweakStore10.updateValue(page.panel.id, meta.path, !checked);
                                      }
                                    },
                                    children: [
                                      /* @__PURE__ */ jsx10(MoveModRing, { panelId: page.panel.id, path: meta.path }),
                              ...
                              return /* @__PURE__ */ jsxs10(
                                "div",
                                {
                                  ...
                                  onPointerMove: (e) => {
                                    if (!TweakStore10.isDisabled(page.panel.id, meta.path) && dragPath === meta.path) dialFromPointer(e, meta);
                                  },
                                  onPointerUp: () => {
                                    setDragPath(null);
                                    fineRef.current = null;
                            ...
                            color && colorMeta ? /* @__PURE__ */ jsx10(MoveOpacityPads, { color, disabled: TweakStore10.isDisabled(page.panel.id, colorMeta.path) }) : shownPadRows.map((row) => {
                              if (appRowAt(row) !== null) {
                                ...
                                return /* @__PURE__ */ jsx10(
                                  "div",
                                  {
                                    ...
                                    children: /* @__PURE__ */ jsx10("span", { className: "tweakers-move-app-row-label", children: surface.padsLabel ?? "the app\u2019s pads" })
                                  },
                                  "app-rows"
                                );
                              }
                                  ...
                                  children: (stripMode ? visibleCols : Array.from({ length: padGridCols }, (_, i) => i)).map((col) => {
                                      ...
                                      return /* @__PURE__ */ jsxs10(
                                        "div",
                                        {
                                          ...
                                          children: [
                                            ...
                                            /* @__PURE__ */ jsx10("div", { className: "tweakers-move-tab-zones", role: "tablist", "aria-label": meta.label, children: options.map((opt, i) => /* @__PURE__ */ jsx10(
                                              "button",
                                              {
                                                type: "button",
                                                role: "tab",
                                                ...
                                                disabled: TweakStore10.isDisabled(page.panel.id, meta.path),
                                                onClick: () => TweakStore10.updateValue(
                                                  page.panel.id,
                                                  meta.path,
                                                  enumOptionValue(opt)
                                                ),
                                    ...
                                    if (padRows[row] === page.toggles && meta.type !== "color") {
                                      return /* @__PURE__ */ jsx10(
                                        "button",
                                        {
                                          ...
                                          onClick: () => TweakStore10.updateValue(page.panel.id, meta.path, !values[meta.path]),
                                    ...
                                    if (padRows[row] === page.actions) {
                                      return /* @__PURE__ */ jsx10(
                                        "button",
                                        {
                                          className: "tweakers-move-pad",
                                          "data-kind": "action",
                                          onClick: () => TweakStore10.triggerAction(page.panel.id, meta.path),
                                    ...
                                    return /* @__PURE__ */ jsx10(
                                      "button",
                                      {
                                        ...
                                        children: isColor ? /* @__PURE__ */ jsx10(MovePadColorBody, { label: meta.label, color: String(values[meta.path]) }) : /* @__PURE__ */ jsx10(MovePadValueBody, { label: meta.label, value: value.num, unit: value.unit, children: /* @__PURE__ */ jsx10(MoveModRing, { panelId: page.panel.id, path: meta.path, pad: true }) })
                                      },
                                      meta.path
                                    );
                                  })
...
function MovePresetScreen({ view, search }) {
  ...
  return /* @__PURE__ */ jsxs10(
    "div",
    {
      ...
      children: [
        search && /* @__PURE__ */ jsx10(MoveSearchBar, { view: search }),
        /* @__PURE__ */ jsx10(
          ListScreen,
          {
            items: rows,
...
function MoveSearchBar({ view }) {
  ...
  return /* @__PURE__ */ jsxs10("div", { className: "tweakers-move-search", role: "search", children: [
    /* @__PURE__ */ jsx10("svg", { className: "tweakers-move-search-icon", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ jsx10("path", { d: ICON_SEARCH, stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }),
    /* @__PURE__ */ jsx10(
      "input",
      {
        ref: inputRef,
...
function useDockBottom(active) {
  const [bottom, setBottom] = useState8(MOVE_NOTIFY_GAP);
  useEffect10(() => {
...
function NotifyStack({ className }) {
  ...
  return /* @__PURE__ */ jsx12(
    Toast.Viewport,
    {
      ...
      children: toasts.map((toast) => /* @__PURE__ */ jsx12(Toast.Root, { toast, className: "tweakers-move-notify-card", children: /* @__PURE__ */ jsxs12(Toast.Content, { className: "tweakers-move-notify-body", children: [
        /* @__PURE__ */ jsxs12("div", { className: "tweakers-move-notify-text", children: [
          toast.type && toast.type !== "info" && /* @__PURE__ */ jsxs12("span", { className: "tweakers-move-notify-kind", children: [
            /* @__PURE__ */ jsx12("span", { className: "tweakers-move-notify-dot", "aria-hidden": "true" }),
            toast.type
          ] }),
          toast.title != null && /* @__PURE__ */ jsx12(Toast.Title, { className: "tweakers-move-notify-title" }),
          toast.description != null && /* @__PURE__ */ jsx12(Toast.Description, { className: "tweakers-move-notify-description" })
        ] }),
        /* @__PURE__ */ jsx12(Toast.Action, { className: "tweakers-move-notify-action" }),
        /* @__PURE__ */ jsx12(Toast.Close, { className: "tweakers-move-notify-close", "aria-label": "Dismiss", children: /* @__PURE__ */ jsx12("svg", { viewBox: "0 0 24 24", width: "14", height: "14", "aria-hidden": "true", children: /* @__PURE__ */ jsx12("path", { d: ICON_CLOSE }) }) })
      ] }) }, toast.id))
    }
  );
}
function MoveNotifications({
  ...
  return createPortal4(
    /* @__PURE__ */ jsx12("div", { className: "tweakers-root tweakers-move-surface tweakers-move-notify-root", children: /* @__PURE__ */ jsx12(Toast.Provider, { toastManager: manager, limit, timeout, children: /* @__PURE__ */ jsx12(NotifyStack, { ...className ? { className } : {} }) }) }),
    document.body
  );
}
...
// src/index.ts
import { TweakStore as TweakStore11, TAB_PATH, parseListItemSchema, groupListFields, defaultListItemParams, normalizeListItems, hintDomId } from "tweakers/store";
export {
  ADSR_DEF,
  ADSR_STAGE_MAX,
  ANGLE_DEAD_ZONE_PX,
