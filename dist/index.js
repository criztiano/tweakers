...
function MoveSlotXYBody({ label, value, position, gridN, shape = null }) {
  return /* @__PURE__ */ jsxs36(Fragment10, { children: [
    /* @__PURE__ */ jsx41("div", { className: "tweakers-move-xy", children: shape !== null ? /* @__PURE__ */ jsx41(MoveSlotShape, { d: shape, className: "tweakers-move-xy-curve" }) : /* @__PURE__ */ jsxs36(Fragment10, { children: [
      gridN > 0 && /* @__PURE__ */ jsx41("span", { className: "tweakers-move-xy-grid", style: {
        "--tweak-xy-grid-step-x": `${100 / gridN}%`,
        "--tweak-xy-grid-step-y": `${100 / gridN}%`
      } }),
      /* @__PURE__ */ jsx41("span", { className: "tweakers-move-xy-line", "data-axis": "x", style: { top: `${position.y * 100}%` } }),
      /* @__PURE__ */ jsx41("span", { className: "tweakers-move-xy-line", "data-axis": "y", style: { left: `${position.x * 100}%` } }),
      /* @__PURE__ */ jsx41("span", { className: "tweakers-move-xy-dot", style: { left: `${position.x * 100}%`, top: `${position.y * 100}%` } })
    ] }) }),
    /* @__PURE__ */ jsx41(MoveSlotReadout, { label, value })
  ] });
}
...
import { Fragment as Fragment11, jsx as jsx47, jsxs as jsxs42 } from "react/jsx-runtime";
  ...
  return /* @__PURE__ */ jsxs42(Fragment11, { children: [
    ...
    /* @__PURE__ */ jsx47(
      "div",
      {
        ...
        title: barTitle,
        children: composite ? /* @__PURE__ */ jsx47(Fragment11, { children: width > 56 && /* @__PURE__ */ jsx47("span", { className: "tweakers-timeline-clip-duration", children: durationText }) }) : isSteps ? /* @__PURE__ */ jsxs42(Fragment11, { children: [
          steps.map((step) => {
        ...
        ] }) : /* @__PURE__ */ jsxs42(Fragment11, { children: [
